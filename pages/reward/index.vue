<template>
  <div>
    ...
    <v-container class="pt-0 pb-0">
      ...
      <v-row>
        <v-col>
          <v-btn v-if="isDone == false" rounded color="#655D8A" dark class="w-100 mt-10 my-btn scan" @click="scan">
          ...
          <v-btn v-if="isDone == true" rounded color="#655D8A" dark class="w-100 mt-10 my-btn" @click="next">Redeem Reward</v-btn>
        </v-col>
      </v-row>
    </v-container>
  </div>
